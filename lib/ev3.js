...
var EV3 = function (_EventEmitter) {
  ...
  function EV3() {
    ...
    _this.motors = {
      ...
      rightMotor: new _ev3devLang2.default.LargeMotor('outC'),
    ...
    if (!_this.motors.rightMotor.connected) throw Error('Right motor(outC) is not connected');
    if (!_this.motors.detectMotor.connected) throw Error('Detecting motor(outC) is not connected');
  ...
  _createClass(EV3, [{
    ...
    value: function look(dir) {
      ...
      var promise = new Promise(function (res, rej) {
        ...
        _this3.motors.detectMotor.speedRegulationEnabled = true;
        _this3.motors.detectMotor.speedSp = speed;
        _this3.motors.sendCommand('run-forever');

        _timeQueue.timeQueue.push(function () {
          if (_this3.detect(minWalkDis)) {
            res({ dir: dir, isOK: true });
            return true;
          } else if (_this3.motors.detectMotor.position >= 90) {
      ...
      return promise.then(function (result) {
        ...
        return new Promise(function (res, rej) {
          _timeQueue.timeQueue.push(function () {
            if (Math.abs(_this3.detectMotor.position) <= minDev) {
              res(result);
              return true;
            }
          });
        ...
        return _this3.motors.sendCommand('stop');
      });
    }
  }, {
    key: 'detect',
    ...
    value: function rotate(dir) {
      ...
      var promise = new Promise(function (res, req) {
